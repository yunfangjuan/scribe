...
cd thrift-0.9.1; ./configure --with-boost=/usr/local; make; sudo make install; cd ../;
# install fb303
cd thrift-0.9.1/contrib/fb303; ./configure --with-boost=/usr/local; make; sudo make install; cd ../../..; 
